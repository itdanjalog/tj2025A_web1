	    ...
	    <div class="col-md-10 mx-auto col-lg-5">
	      ...
	      <form id="signupform" class="p-4 p-md-5 border rounded-3 bg-body-tertiary">
	        ...
	        <div class="form-floating mb-3">
	          <input type="text" name="mid" class="form-control" id="floatingInput1" placeholder="계정아이디" onkeyup="아이디중복검사()">
	          <label for="floatingInput1">계정아이디</label>
	        </div>
			<div class="idcheck" id="idcheck" style="min-height: 30px; font-size: 12px; padding-left: 10px;">
	        ...
	        <div class="form-floating mb-3">
	          ...
	          <label for="floatingInput4">닉네임</label>
	       	...
	       	<div class="form-floating mb-3">
	          <input type="text" name="mphone" class="form-control" id="floatingInput5" placeholder="연락처"  onkeyup="연락처검사()">
	          <label for="floatingInput5">연락처</label>
	        </div>

			<div class="phonecheck" id="phonecheck" style="min-height: 30px; font-size: 12px; padding-left: 10px;">
